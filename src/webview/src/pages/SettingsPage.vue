<template>
  <div class="cursor-settings-pane-outer-wrapper !outline-none" tabindex="-1">
    <div class="scrollable-div-container custom-scroll-container" style="height: 100%; overflow-y: auto; overflow-x: hidden; scrollbar-gutter: stable;">
      <div class="cursor-settings-layout-main">
        <SettingsSidebar :active-tab="activeTab" :tabs="tabs" @update:active-tab="activeTab = $event" />
...
// 复用全局 Transport 实例，统一 Settings 与其他页面的通信通道
...
const tabs = [
  ...
  { id: 'agents', label: 'Agents', icon: 'codicon-infinity' },
  { id: 'tab', label: 'Tab', icon: 'codicon-tab' },
  { id: 'models', label: 'Models', icon: 'codicon-cube', divider: true },
  { id: 'tools', label: 'Tools & MCP', icon: 'codicon-cube-nodes', divider: true },
  { id: 'rules', label: 'Rules, Memories, Commands', icon: 'codicon-clipboard-list' },
  { id: 'indexing', label: 'Indexing & Docs', icon: 'codicon-cylinder-split' },
  { id: 'network', label: 'Network', icon: 'codicon-globe' },
  { id: 'beta', label: 'Beta', icon: 'codicon-chevron-forward-dotted' },
]
...
:root {
  ...
  --cursor-stroke-yellow-secondary: color-mix(in srgb,var(--vscode-charts-yellow) 32%,transparent);
  ...
  --cursor-stroke-magenta-secondary: color-mix(in srgb,var(--vscode-charts-purple) 32%,transparent);
  ...
  --cursor-box-shadow-lg: 0 0 4px 0 hsla(0,0%,100%,.05) inset,0 0 3px 0 var(--cursor-shadow-secondary),0 16px 24px 0 var(--cursor-shadow-tertiary);
  --cursor-box-shadow-xl: 0 0 4px 0 hsla(0,0%,100%,.05) inset,0 0 6px 8px var(--cursor-shadow-secondary),0 24px 16px 6px var(--cursor-shadow-tertiary);
  --cursor-shadow-workbench: 0 0 8px 2px color-mix(in srgb,var(--vscode-widget-shadow) 40%,transparent);
...
@media (prefers-color-scheme: dark) {
  :root {
    ...
    --cursor-icon-yellow-secondary: color-mix(in srgb,var(--vscode-charts-yellow) 64%,transparent);
    ...
    --cursor-icon-magenta-secondary: color-mix(in srgb,var(--vscode-charts-purple) 64%,transparent);
    ...
    --cursor-stroke-yellow-secondary: color-mix(in srgb,var(--vscode-charts-yellow) 56%,transparent);
    --cursor-stroke-green-primary: var(--vscode-charts-green);
    --cursor-stroke-green-secondary: color-mix(in srgb,var(--vscode-charts-green) 56%,transparent);
    --cursor-stroke-magenta-primary: var(--vscode-charts-purple);
    --cursor-stroke-magenta-secondary: color-mix(in srgb,var(--vscode-charts-purple) 56%,transparent)
  }
}
...
.cursor-badge-primary,.cursor-badge-success {
...
.scrollable-div-container.show-only-on-hover:not(:hover) .scrollbar,.scrollable-div-container.show-only-on-scroll:not(.is-scrolling) .scrollbar,.show-only-on-hover-force:not(:hover) .scrollbar {
    opacity: 0!important
}
